...
const TableHead = React.forwardRef(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-12 px-4 text-left align-middle font-medium text-white/40 text-xs uppercase [&:has([role=checkbox])]:pr-0",
      className
    )}
    {...props}
  />
...
const TableCell = React.forwardRef(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn("p-4 align-middle text-white/60 [&:has([role=checkbox])]:pr-0", className)}
    {...props}
  />
))
