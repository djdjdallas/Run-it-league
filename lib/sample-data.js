...
export const sampleSponsors = [
  ...
  },
  {
    id: "sponsor-2",
    name: "Gatorade",
    logo_url: "https://upload.wikimedia.org/wikipedia/en/thumb/7/74/Gatorade_logo.svg/200px-Gatorade_logo.svg.png",
    website_url: "https://www.gatorade.com",
    tier: "premium",
    is_active: true,
    display_order: 2,
  },
...
export const sampleGalleryPhotos = [
  {
    id: "photo-1",
    title: "Opening Night Action",
    description: "Thunder Hawks vs Fire Dragons season opener",
  ...
  },
  {
    ...
    description: "Last season's championship celebration",
    image_url: "https://images.unsplash.com/photo-1504450758481-7338bbe75c8e?w=800",
    category: "events",
    game_id: null,
    is_featured: true,
  ...
  },
  {
    id: "photo-3",
    title: "Team Practice",
    description: "Storm Chasers working on their plays",
...
export const sampleStreams = [
  {
    id: "stream-1",
    title: "Thunder Hawks vs Storm Chasers - LIVE",
    description: "Week 5 matchup featuring two top teams",
...
// Sample events (non-game)
export const sampleEvents = [
  {
    id: "event-1",
    title: "Spring Season Tryouts",
    description: "Open tryouts for all skill levels. Bring your own shoes and water bottle.",
    event_type: "tryout",
    location: "Main Gym",
...
// Sample registrations (for admin view)
...
export const sampleTeamRegistrations = [
  {
    id: "team-reg-1",
    team_name: "Downtown Ballers",
    primary_color: "#2563EB",
    secondary_color: "#FBBF24",
    captain_name: "Marcus Thompson",
    captain_email: "marcus.t@email.com",
    captain_phone: "(555) 111-2222",
    status: "roster_complete",
    roster_token: "abc123def456",
    roster_token_expires_at: new Date(Date.now() + 7 * 24 * 60 * 60 * 1000).toISOString(),
    min_players: 5,
    max_players: 15,
    created_at: new Date(Date.now() - 10 * 24 * 60 * 60 * 1000).toISOString(),
    paid_at: new Date(Date.now() - 10 * 24 * 60 * 60 * 1000).toISOString(),
    roster_completed_at: new Date(Date.now() - 9 * 24 * 60 * 60 * 1000).toISOString(),
    team_id: "team-7",
  },
  {
    id: "team-reg-2",
    team_name: "West Side Warriors",
    primary_color: "#DC2626",
    secondary_color: "#FFFFFF",
    captain_name: "James Wilson",
    captain_email: "jwilson@email.com",
    captain_phone: "(555) 333-4444",
    status: "paid",
    roster_token: "xyz789uvw012",
    roster_token_expires_at: new Date(Date.now() + 5 * 24 * 60 * 60 * 1000).toISOString(),
    min_players: 5,
    max_players: 15,
    created_at: new Date(Date.now() - 2 * 24 * 60 * 60 * 1000).toISOString(),
...
// Sample team roster entries (for paid but incomplete registrations)
export const sampleTeamRosterEntries = [
  { id: "roster-1", team_registration_id: "team-reg-2", player_name: "James Wilson", created_at: new Date(Date.now() - 1 * 24 * 60 * 60 * 1000).toISOString() },
  { id: "roster-2", team_registration_id: "team-reg-2", player_name: "Anthony Davis", created_at: new Date(Date.now() - 1 * 24 * 60 * 60 * 1000).toISOString() },
  { id: "roster-3", team_registration_id: "team-reg-2", player_name: "Mike Brown", created_at: new Date(Date.now() - 1 * 24 * 60 * 60 * 1000).toISOString() },
]
