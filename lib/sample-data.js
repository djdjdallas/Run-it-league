...
export const sampleGalleryPhotos = [
  ...
  },
  {
    ...
    description: "Fans filling the stands",
  ...
  },
  {
    ...
    description: "All-Star weekend highlights",
  ...
  },
  {
    id: "photo-6",
    title: "Youth Clinic",
    description: "Players coaching the next generation",
...
export const sampleStreams = [
  ...
  {
    id: "stream-2",
    title: "Fire Dragons vs Night Owls",
    description: "Battle for playoff positioning",
    stream_url: "https://www.youtube.com/embed/dQw4w9WgXcQ",
    stream_type: "youtube",
    game_id: "game-5",
    is_live: false,
    scheduled_time: new Date(Date.now() + 3 * 24 * 60 * 60 * 1000).toISOString(),
    thumbnail_url: "https://images.unsplash.com/photo-1504450758481-7338bbe75c8e?w=400",
    created_at: new Date().toISOString(),
  },
]
...
export const sampleEvents = [
  ...
  {
    id: "event-2",
    title: "Skills Training Camp",
    description: "Two-day intensive skills development camp with professional coaches.",
    event_type: "training",
    location: "Community Center",
    start_time: new Date(Date.now() + 21 * 24 * 60 * 60 * 1000).toISOString(),
    end_time: new Date(Date.now() + 22 * 24 * 60 * 60 * 1000).toISOString(),
    max_participants: 30,
  ...
  },
  {
    ...
    description: "Join us to celebrate our players and teams with awards and refreshments.",
    event_type: "social",
    location: "Sports Bar & Grill",
    start_time: new Date(Date.now() + 60 * 24 * 60 * 60 * 1000).toISOString(),
    end_time: new Date(Date.now() + 60 * 24 * 60 * 60 * 1000 + 4 * 60 * 60 * 1000).toISOString(),
