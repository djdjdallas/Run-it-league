...
import { Camera, Grid, Star, X, ChevronLeft, ChevronRight } from "lucide-react"
import { sampleGalleryPhotos } from "@/lib/sample-data"
...
export default function GalleryPage() {
  ...
  const filteredPhotos =
    selectedCategory === "all"
      ? sampleGalleryPhotos
      : sampleGalleryPhotos.filter((p) => p.category === selectedCategory)
